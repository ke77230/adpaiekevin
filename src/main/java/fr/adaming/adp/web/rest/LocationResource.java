...
/**
 * REST controller for managing {@link fr.adaming.adp.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    public List<Location> getAllLocations(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
