...
/**
 * REST controller for managing {@link fr.adaming.adp.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Employee> partialUpdateEmployee(
        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(existingEmployee -> {
                ...
                if (employee.getNumeroSecuriteSociale() != null) {
                    existingEmployee.setNumeroSecuriteSociale(employee.getNumeroSecuriteSociale());
                }
                if (employee.getQualification() != null) {
                    existingEmployee.setQualification(employee.getQualification());
                }
                if (employee.getTauxImposition() != null) {
                    existingEmployee.setTauxImposition(employee.getTauxImposition());
                }
