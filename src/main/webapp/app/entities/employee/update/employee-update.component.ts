...
export class EmployeeUpdateComponent implements OnInit {
  ...
  protected updateForm(employee: IEmployee): void {
    ...
    this.jobsSharedCollection = this.jobService.addJobToCollectionIfMissing<IJob>(this.jobsSharedCollection, ...(employee.jobs ?? []));
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.employeeService
      ...
      .pipe(
        map((employees: IEmployee[]) =>
          this.employeeService.addEmployeeToCollectionIfMissing<IEmployee>(employees, this.employee?.employee)
        )
      )
    ...
    this.jobService
      ...
      .pipe(map((jobs: IJob[]) => this.jobService.addJobToCollectionIfMissing<IJob>(jobs, ...(this.employee?.jobs ?? []))))
