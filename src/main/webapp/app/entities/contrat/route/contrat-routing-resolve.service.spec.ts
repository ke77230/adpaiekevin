...
describe('Contrat routing resolve service', () => {
  ...
  let routingResolveService: ContratRoutingResolveService;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(ContratRoutingResolveService);
  ...
  describe('resolve', () => {
    it('should return IContrat returned by find', () => {
      ...
      expect(resultContrat).toEqual({ id: 123 });
    });
