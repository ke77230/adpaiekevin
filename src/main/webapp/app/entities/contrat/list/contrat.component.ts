...
import { EntityArrayResponseType, ContratService } from '../service/contrat.service';
...
export class ContratComponent implements OnInit {
  ...
  trackId = (_index: number, item: IContrat): number => this.contratService.getContratIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.contrats = this.refineData(dataFromBody);
  }
