...
import fr.adaming.adp.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    private static final String DEFAULT_NUMERO_SECURITE_SOCIALE = "AAAAAAAAAAAAAAA";
    private static final String UPDATED_NUMERO_SECURITE_SOCIALE = "BBBBBBBBBBBBBBB";

    private static final String DEFAULT_QUALIFICATION = "AAAAAAAAAA";
    private static final String UPDATED_QUALIFICATION = "BBBBBBBBBB";

    private static final Float DEFAULT_TAUX_IMPOSITION = 1F;
    private static final Float UPDATED_TAUX_IMPOSITION = 2F;
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .tauxImposition(DEFAULT_TAUX_IMPOSITION);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee()
            ...
            .tauxImposition(UPDATED_TAUX_IMPOSITION);
        return employee;
    }
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNumeroSecuriteSociale()).isEqualTo(DEFAULT_NUMERO_SECURITE_SOCIALE);
        assertThat(testEmployee.getQualification()).isEqualTo(DEFAULT_QUALIFICATION);
        assertThat(testEmployee.getTauxImposition()).isEqualTo(DEFAULT_TAUX_IMPOSITION);
    }
    ...
    @Test
    @Transactional
    void checkNumeroSecuriteSocialeIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
        employee.setNumeroSecuriteSociale(null);
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].tauxImposition").value(hasItem(DEFAULT_TAUX_IMPOSITION.doubleValue())));
    }
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.tauxImposition").value(DEFAULT_TAUX_IMPOSITION.doubleValue()));
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNumeroSecuriteSociale()).isEqualTo(UPDATED_NUMERO_SECURITE_SOCIALE);
        assertThat(testEmployee.getQualification()).isEqualTo(UPDATED_QUALIFICATION);
        assertThat(testEmployee.getTauxImposition()).isEqualTo(UPDATED_TAUX_IMPOSITION);
    }
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.lastName(UPDATED_LAST_NAME).numeroSecuriteSociale(UPDATED_NUMERO_SECURITE_SOCIALE);
